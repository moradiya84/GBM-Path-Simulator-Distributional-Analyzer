...
public:
  ...
  // spot_path: the realized stock prices (should have size == grid.num_steps() + 1)
  HedgingResult backtest_path(const TimeGrid& grid, const std::vector<double>& spot_path) const;
