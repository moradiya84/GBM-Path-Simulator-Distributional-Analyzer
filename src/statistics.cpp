...
double Statistics::compute_mean(const std::vector<double> &terminal_values) const
{
...
double Statistics::compute_variance(const std::vector<double> &terminal_values) const
{
...
double Statistics::compute_skewness(const std::vector<double> &terminal_values) const
{
...
double Statistics::compute_kurtosis(const std::vector<double> &terminal_values) const
{
